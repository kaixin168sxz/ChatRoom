...
use_resize = True
replace_username = Config('./Database/users.json', 'replace')
allow_signup = True
blacklist = Config('./Database/users.json', 'blacklist')
unrestricted_page_routes = {'/signin', '/signup'}
allow_blackuser = {'/signin', '/signup', '/black_user'}
use_markdown = Config('./Database/users.json', 'markdown')
admin_users = Config('./Database/users.json', 'admin')
use_html = Config('./Database/users.json', 'html')
